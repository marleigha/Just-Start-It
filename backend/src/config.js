...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'd6139bad55db5e799582c1a7305f3853',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Just Start It <app@flatlogic.app>',
  ...
  project_uuid: 'dcc28837-9dfa-4781-93d0-527d845218e1',
  flHost:
...
config.pexelsQuery = 'student organizing tasks';
config.host =
