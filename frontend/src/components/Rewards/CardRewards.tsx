...
const CardUsers = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_REWARDS');
            ...
            >
              ...
              >
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    ...
                    onEdit={onEdit}
                    itemId={item.id}
                    pathEdit={`/rewards/rewards-edit/?id=${item.id}`}
                    pathView={`/rewards/rewards-view/?id=${item.id}`}
              ...
              <dl className='divide-y  divide-stone-600   dark:divide-dark-700 px-6 py-4 text-sm leading-6 h-64 overflow-y-auto'>
                <div className='flex justify-between gap-x-4 py-3'>
                  <dt className='  text-gray-200  dark:text-dark-600'>Name</dt>
                ...
                <div className='flex justify-between gap-x-4 py-3'>
                  <dt className='  text-gray-200  dark:text-dark-600'>User</dt>
                  <dd className='flex items-start gap-x-2'>
                    <div className='font-medium line-clamp-4'>
