...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/tasks/tasksSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTasksCols';
...
const TableSampleTasks = ({
  ...
  useEffect(() => {
    if (tasksNotify.showNotification) {
      notify(tasksNotify.typeNotification, tasksNotify.textNotification);
    }
  }, [tasksNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/tasks/tasks-view/?id=${id}`);
  };
