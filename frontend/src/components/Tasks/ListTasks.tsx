            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>HardnessLevel</p>
                    <p className={'line-clamp-2'}>{item.hardness_level}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>Deadline</p>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>UrgencyLevel</p>
                    <p className={'line-clamp-2'}>{item.urgency_level}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>PointValue</p>
                    <p className={'line-clamp-2'}>{item.point_value}</p>
                  </div>
