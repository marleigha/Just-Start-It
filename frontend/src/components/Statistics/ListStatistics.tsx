...
const ListStatistics = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_STATISTICS');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>StartDate</p>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>EndDate</p>
                    <p className={'line-clamp-2'}>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/statistics/statistics-edit/?id=${item.id}`}
                  pathView={`/statistics/statistics-view/?id=${item.id}`}
