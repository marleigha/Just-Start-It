              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>First Name</p>
                    <p className={'line-clamp-2'}>{item.firstName}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>Last Name</p>
                    <p className={'line-clamp-2'}>{item.lastName}</p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>Phone Number</p>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>Disabled</p>
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>Avatar</p>
                    <ImageField
                      name={'Avatar'}
                      image={item.avatar}
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-200 '}>App Role</p>
                    <p className={'line-clamp-2'}>
