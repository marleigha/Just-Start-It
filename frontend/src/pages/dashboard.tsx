...
const Dashboard = () => {
  ...
  const [rewards, setRewards] = React.useState('Loading...');
  const [statistics, setStatistics] = React.useState('Loading...');
  ...
  return (
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-4 mb-6 grid-flow-dense'>
          {(isFetchingQuery || loading) && (
            <div
              ...
              } dark:bg-dark-900 text-lg leading-tight   text-gray-200 flex items-center ${cardsStyle} dark:border-dark-700 p-6`}
            >
              <BaseIcon
        ...
        {!!rolesWidgets.length && (
          <hr className='my-6 text-neonGreenTheme-mainBG  ' />
        )}
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_STATISTICS') && (
